...
export default async function WorkerNotificationsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Notifications"
        description="Stay updated on your tasks, payouts, and account activity"
        action={
          unreadCount > 0 ? (
        ...
        <Card>
          <div className="py-6">
            <EmptyState
              ...
              description="When you receive task updates, payouts, or other alerts, they'll appear here."
            />
          </div>
        </Card>
      ) : (
