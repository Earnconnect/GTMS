...
export default async function BusinessNotificationsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Notifications"
        description="Stay updated on deposits, tasks, disputes, and account activity"
        action={
          unreadCount > 0 ? (
        ...
        <Card>
          <div className="py-6">
            <EmptyState
              ...
              description="When you receive deposit updates, task activity, or other alerts, they'll appear here."
            />
          </div>
        </Card>
      ) : (
